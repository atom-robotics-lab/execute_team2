                ...
                {pattern.detectedAreas.map((area: any, idx: number) => (
                  <div key={idx} className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div className="mt-3 space-y-3">
                      ...
                      <div className="bg-white p-3 rounded-lg border border-gray-200">
                        <p className="font-medium text-gray-900 mb-2">Technical Evidence:</p>
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-gray-600">Error Level Analysis</span>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 flex-grow">
                    ...
                    <div className="mt-2 space-y-3">
                      ...
                      <div className="bg-white/50 p-3 rounded">
                        <p className="font-medium text-gray-900 mb-1">Software Traces:</p>
                        <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
                          <li>Adobe Photoshop CC 2024 editing signatures</li>
                          <li>AI image generation model artifacts (Stable Diffusion v2.1)</li>
                          <li>Multiple layer merging operations detected</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="w-full bg-blue-200 rounded-full h-2.5">
                      <div className="bg-blue-600 h-2.5 rounded-full progress-animate" style={{ width: '98.5%' }}></div>
                    </div>
                    <p className="text-xs text-gray-500 mt-1">Based on analysis of over 1 million similar cases</p>
                  </div>

                  <div className="bg-white/50 p-3 rounded">
                    <p className="font-medium text-gray-900 mb-2">Detection Models Used:</p>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Image Manipulation</span>
                        <span className="text-sm font-medium text-blue-600">98.7%</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">AI Generation</span>
                        <span className="text-sm font-medium text-blue-600">97.5%</span>
                      </div>
                    </div>
                  </div>
                  ...
                  {expandedEvidence === alert.category && (
                    <div className="border-t border-gray-200">
                      {alert.patterns.map((pattern, idx) => (
                        <div key={idx} className="px-6 pb-6 evidence-expand">
